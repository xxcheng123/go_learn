...
func (cq *CarQuery) QueryHost() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, car.HostTable, car.HostColumn),
		)
...
func (cq *CarQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (cq *CarQuery) WithHost(opts ...func(*UserQuery)) *CarQuery {
	query := (&UserClient{config: cq.config}).Query()
...
func (cq *CarQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Car, error) {
	...
	if query := cq.withHost; query != nil {
		if err := cq.loadHost(ctx, query, nodes, nil,
			func(n *Car, e *User) { n.Edges.Host = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *CarQuery) loadHost(ctx context.Context, query *UserQuery, nodes []*Car, init func(*Car), assign func(*Car, *User)) error {
...
func (cq *CarQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(car.Table, car.Columns, sqlgraph.NewFieldSpec(car.FieldID, field.TypeInt64))
	_spec.From = cq.sql
